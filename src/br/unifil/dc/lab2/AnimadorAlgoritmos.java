...
public class AnimadorAlgoritmos extends JFrame {
    ...
    public void onBtnCarregarPressionado() {
        ...
        switch (algoritmo) {
            ...
            case ORDENACAO_INSERCAO:
                novoFilme = AlgoritmosAnimados.ordenarInsercao(valores);
                break;

            case ORDENACAO_QUICKSORT:
                novoFilme = AlgoritmosAnimados.ordenarQuickSort(valores);
                break;

            case ORDENACAO_MERGESORT:
                novoFilme = AlgoritmosAnimados.ordenarMergeSort(valores);
                break;
    ...
    private static List<Integer> textoParaLista(String textoValores) {
        String[] numerosTxt = textoValores.replaceAll(" ", "").split(",");
